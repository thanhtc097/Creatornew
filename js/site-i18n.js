(function () {
  ...
  const translations = {
    ...
    'AI Image Upscaler': 'Tăng chất lượng ảnh AI',
    'AI Image Upscaler & Enhancer': 'Tăng chất lượng ảnh AI & Sửa ảnh mờ',
    'Increase resolution & fix blur': 'Phóng to & sửa ảnh mờ',
    'Increase resolution 2X-8X & fix blur': 'Phóng to 2X-8X & sửa ảnh mờ',
    'Skip to Image Upscaler': 'Đi đến công cụ tăng chất lượng ảnh',
    'Upscale image →': 'Làm nét ảnh ngay →',
    'AI Image Expander': 'Mở rộng ảnh AI',
    'AI Image Expander & Generative Fill': 'Mở rộng ảnh bằng AI & Generative Fill',
    'Uncrop & generative fill': 'AI Uncrop & Generative Fill',
    'Skip to Image Expander': 'Đi đến công cụ mở rộng ảnh',
    'Expand image →': 'Mở rộng khung ảnh →',
